...
namespace Follower_Analyzer_for_Instagram.Models
{
    ...
    public class ApplicationUser
    {
        ...
        // Поле для ID пользователя в Instagram 
        // (так как остальные данные могут изменяться, целесообразным посчитали хранить именно ID)
        [Key]
        ...
        // Кода последний раз была фиксация состояния пользователя
